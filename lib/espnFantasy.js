...
// ESPN's player.proTeamId -> the real NFL team's standard abbreviation. This
// is the same mapping widely documented by community tools (e.g. espn-api);
// not yet confirmed against a live sync here, so treat an unexpected/missing
// "who do they play" on the Props tab as a mapping gap to check first.
const PRO_TEAM = {
    ...
    for (const side of [m.home, m.away]) {
      ...
      for (const e of entries) {
        ...
        playerLines.push({
          ...
          nflTeam: PRO_TEAM[player.proTeamId] || null,
