...
// both use. Kept in one place because the two had drifted: the home page was
// still listing ten cards long after the weekly pages shipped.
//
...
export const SECTIONS = [
  {
    ...
    items: [
      ...
      ['Roster Moves', '/roster-moves', 'Trades and waiver pickups the sync detected'],
  ...
  },
  {
    ...
    featured: { label: 'Sportsbook', href: '/sportsbook', desc: 'Moneylines, parlays and settled bets' },
    items: [
      ['Sportsbook', '/sportsbook', 'Moneylines, parlays and settled bets'],
      ['Preweek', '/preweek', 'Stakes, rooting guide and the week’s lines'],
      ['Predictions', '/predictions', 'Weekly lines and season futures'],
      ['Postweek', '/postweek', 'Awards, results and what the week moved'],
    ],
  ...
  },
  {
    ...
    items: [
      ...
      ['Drafts', '/drafts', 'Every draft, graded pick by pick'],
