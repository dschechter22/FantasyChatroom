-- Fantasy Chatroom — database schema
...
create table teams (
  ...
  playoff_result text, -- 'Champion' | 'Runner Up' | 'Mol Bowl Winner' | 'Sacko' | null
  league_id text default 'f35680a1-3392-47e5-abf2-0e81ae662f88',
...
create table roster_entries (
  ...
  fpts numeric,
  prk integer,
  stats jsonb, -- cached per-season Sleeper stat blob, incl. stats.proj.<week>
  league_id text default 'f35680a1-3392-47e5-abf2-0e81ae662f88'
);
...
-- ============================================================
-- draft_picks (historical draft results, graded pick by pick on /drafts)
-- ============================================================
...
create policy "public_all" on draft_picks for all using (true) with check (true);
